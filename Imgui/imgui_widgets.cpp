...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    // Render navigation highlight
    RenderNavHighlight(total_bb, id);

    // Define border color and thickness
    ImU32 border_col = GetColorU32(ImGuiCol_FrameBorder);
    float border_thickness = style.FrameBorderSize;
    window->DrawList->AddRect(check_bb.Min, check_bb.Max, border_col, style.FrameRounding, 0, border_thickness);
    RenderFrame(
        check_bb.Min,
        check_bb.Max,
   ...
   // ImU32 border_col = GetColorU32(ImGuiCol_CheckMarkBorder);

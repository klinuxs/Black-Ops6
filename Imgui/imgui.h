...
enum ImGuiCol_
{
    ...
    ImGuiCol_FrameBorder,           // Border of checkbox, radio button, plot, slider, text input
    ...
    ImGuiCol_CheckMarkBorder,             // Checkbox tick and RadioButton circle
    ImGuiCol_SliderGrab,
...
struct ImGuiStyle
{
    ...
    float       TableAngledHeadersAngle;    // Angle of angled headers (supported values range from -30.0f degrees to +30.0f degrees).
